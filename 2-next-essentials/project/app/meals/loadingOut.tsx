...
// --- DEPRECATED CODE, USED TO EXEMPLIFY A NEXT LOADING COMPONENT ---
/**
 * A [loading.tsx/jsx] component is a reserved one for Next. It is used to handle its related page
 * loading state.
